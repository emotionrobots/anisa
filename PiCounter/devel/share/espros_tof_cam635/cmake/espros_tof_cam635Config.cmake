...
if("TRUE" STREQUAL "TRUE")
  set(espros_tof_cam635_SOURCE_PREFIX /home/ubuntu/PiCounter/src/espros_tof_cam635)
  set(espros_tof_cam635_DEVEL_PREFIX /home/ubuntu/PiCounter/devel)
  ...
  set(espros_tof_cam635_INSTALL_PREFIX /home/ubuntu/PiCounter/install)
...
if(NOT "/home/ubuntu/PiCounter/devel/include;/home/ubuntu/PiCounter/src/espros_tof_cam635/include " STREQUAL " ")
  set(espros_tof_cam635_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/PiCounter/devel/include;/home/ubuntu/PiCounter/src/espros_tof_cam635/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'espros_tof_cam635' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/PiCounter/src/espros_tof_cam635/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/PiCounter/devel/lib;/home/ubuntu/PiCounter/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND espros_tof_cam635_EXPORTED_TARGETS ${${espros_tof_cam635_dep}_EXPORTED_TARGETS})
endforeach()
